  ...
  return (
    <div className="space-y-3">
      ...
      <div>
        ...
        <input type="file" accept="image/*" onChange={handlePhotoUpload} className="text-gray-400" />
        {form.originalPhoto && <span className="text-gray-500 text-sm ml-2">{form.originalPhoto}</span>}
      </div>
